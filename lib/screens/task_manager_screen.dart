                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: SwitchListTile(
                        ...
                        subtitle: Text(
                          'تنبيه قبل 10 دقائق من موعد المراجعة',
                          style: GoogleFonts.tajawal(
                            fontSize: 12,
                            color: Colors.grey,
                          ),
          ...
          Center(
            child: Column(
              children: [
                ...
                Text(
                  'أضف حصصك من تبويب "الجدول العام"',
                  style: GoogleFonts.tajawal(
          ...
          Center(
            child: Column(
              children: [
                ...
                const SizedBox(height: 6),
                Text(
                  'أضف حصصك الدراسية من تبويب "الجدول العام"',
                  style: GoogleFonts.tajawal(
                    color: isDark ? Colors.white38 : Colors.grey.shade500,
                    fontSize: 14,
                  ),
          ...
          Positioned.fill(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  if (_currentIndex == 0)
                    _buildTodayTasksTab(scheduleProvider, isDark),
                  if (_currentIndex == 1)
                    _buildAllReviewsTab(scheduleProvider, isDark),
                  if (_currentIndex == 2)
                    _buildScheduleTab(scheduleProvider, isDark),
